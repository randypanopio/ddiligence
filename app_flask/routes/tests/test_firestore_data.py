...
class TestFirestoreDataAPI(unittest.TestCase):
    ...
    #     mock_db_manager.get_ticker_data.return_value = [{'date': '2023-01-01', 'close_price': 100.0}]

    #     response = self.client.get('/api/v1/stocks_data?ticker=AAPL&date_start=2023-01-01&date_end=2023-01-01')
    ...
    #     ]
    #     with patch('routes.firestore_data.request') as mock_request:
